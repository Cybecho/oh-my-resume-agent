...
3. `workspace/experience_cards/`를 우선 검증 소스로 사용하고 `workspace/claims/claim_registry.yaml`로 수치/성과를 검증
4. 기존 개인용 seed에서만 `data/experience_cards/`를 legacy fallback으로 사용
5. `08_검수리포트.md` 생성/갱신
6. `state.json`의 review 단계 완료 처리
