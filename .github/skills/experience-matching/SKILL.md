...
2. 후보 구성 순서:
   ...
   - `workspace/claims/claim_registry.yaml`의 approved claim으로 수치/성과 검증
   - `workspace/feedback/log.json` 반영
   - 기존 개인용 seed에서만 `data/experience_cards/`, `data/experiences/_index.md`, `data/feedback/log.json`를 legacy fallback으로 사용
